    ...
    <div className="min-h-screen bg-gray-950 px-4 py-10">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-2xl shadow-2xl p-8">
          <h2 className="text-xl font-semibold text-white mb-2">Round 2 Preferences</h2>
          <p className="text-gray-400 text-sm mb-6">Only hostels with remaining capacity are shown.</p>
